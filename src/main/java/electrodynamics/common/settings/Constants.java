...
public class Constants {
	...
	@DoubleValue(def = 20)
	public static double COMPRESSOR_CONVERSION_RATE = 20;
	@DoubleValue(def = 100)
	public static double DECOMPRESSOR_USAGE_PER_TICK = 100.0;
	@DoubleValue(def = 20)
	public static double DECOMPRESSOR_CONVERSION_RATE = 20;
	@DoubleValue(def = 100)
	public static double ADVACNED_COMPRESSOR_USAGE_PER_TICK = 100.0;
	@DoubleValue(def = 80)
	public static double ADVACNED_COMPRESSOR_CONVERSION_RATE = 80;
	@DoubleValue(def = 100)
	public static double ADVANCED_DECOMPRESSOR_USAGE_PER_TICK = 100.0;
	@DoubleValue(def = 80)
	public static double ADVANCED_DECOMPRESSOR_CONVERSION_RATE = 80;
	@DoubleValue(def = 100)
	public static double THERMOELECTRIC_MANIPULATOR_USAGE_PER_TICK = 100.0;
	@DoubleValue(def = 10)
	public static double THERMOELECTRIC_MANIPULATOR_HEAT_TRANSFER = 10.0;
	@DoubleValue(def = 20)
	public static double THERMOELECTRIC_MANIPULATOR_CONVERSION_RATE = 20.0;
	@DoubleValue(def = 100)
	public static double ADVANCED_THERMOELECTRIC_MANIPULATOR_USAGE_PER_TICK = 100.0;
	@DoubleValue(def = 10)
	public static double ADVANCED_THERMOELECTRIC_MANIPULATOR_HEAT_TRANSFER = 10.0;
	@DoubleValue(def = 80)
	public static double ADVANCED_THERMOELECTRIC_MANIPULATOR_CONVERSION_RATE = 80.0;
	@IntValue(def = 1048576)
	public static int GAS_TRANSFORMER_INPUT_PRESSURE_CAP = 1048576;// 2^20
	@DoubleValue(def = 1000000)
	public static double GAS_TRANSFORMER_INPUT_TEMP_CAP = 1000000;
	@DoubleValue(def = 5000)
	public static double GAS_TRANSFORMER_BASE_INPUT_CAPCITY = 5000;
	@IntValue(def = 1048576)
	public static int GAS_TRANSFORMER_OUTPUT_PRESSURE_CAP = 1048576;// 2^20
	@DoubleValue(def = 1000000)
	public static double GAS_TRANSFORMER_OUTPUT_TEMP_CAP = 1000000;
	@DoubleValue(def = 5000)
	public static double GAS_TRANSFORMER_BASE_OUTPUT_CAPCITY = 5000;
	@DoubleValue(def = 5000)
	public static double GAS_TRANSFORMER_ADDON_TANK_CAPCITY = 5000;
	@IntValue(def = 5)
