...
public class ElectrodynamicsTiles {
	...
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasTankSteel>> TILE_GASTANK_STEEL = BLOCK_ENTITY_TYPES.register("gastanksteel", () -> new BlockEntityType<>(TileGasTankSteel::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gastanksteel)), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasTankReinforced>> TILE_GASTANK_REINFORCED = BLOCK_ENTITY_TYPES.register("gastankreinforced", () -> new BlockEntityType<>(TileGasTankReinforced::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gastankreinforced)), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasTankHSLA>> TILE_GASTANK_HSLA = BLOCK_ENTITY_TYPES.register("gastankhsla", () -> new BlockEntityType<>(TileGasTankHSLA::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gastankhsla)), null));

	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileCompressor>> TILE_COMPRESSOR = BLOCK_ENTITY_TYPES.register("compressor", () -> new BlockEntityType<>(TileCompressor::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_COMPRESSOR.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileDecompressor>> TILE_DECOMPRESSOR = BLOCK_ENTITY_TYPES.register("decompressor", () -> new BlockEntityType<>(TileDecompressor::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_DECOMPRESSOR.get()), null));
	...
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasVent>> TILE_GASVENT = BLOCK_ENTITY_TYPES.register("gasvent", () -> new BlockEntityType<>(TileGasVent::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gasvent)), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileThermoelectricManipulator>> TILE_THERMOELECTRIC_MANIPULATOR = BLOCK_ENTITY_TYPES.register("thermoelectricmanipulator", () -> new BlockEntityType<>(TileThermoelectricManipulator::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_THERMOELECTRICMANIPULATOR.get()), null));

	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasValve>> TILE_GASVALVE = BLOCK_ENTITY_TYPES.register("gasvalve", () -> new BlockEntityType<>(TileGasValve::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_GASVALVE.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileFluidValve>> TILE_FLUIDVALVE = BLOCK_ENTITY_TYPES.register("fluidvalve", () -> new BlockEntityType<>(TileFluidValve::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_FLUIDVALVE.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasPipePump>> TILE_GASPIPEPUMP = BLOCK_ENTITY_TYPES.register("gaspipepump", () -> new BlockEntityType<>(TileGasPipePump::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_GASPIPEPUMP.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileFluidPipePump>> TILE_FLUIDPIPEPUMP = BLOCK_ENTITY_TYPES.register("fluidpipepump", () -> new BlockEntityType<>(TileFluidPipePump::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_FLUIDPIPEPUMP.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileGasPipeFilter>> TILE_GASPIPEFILTER = BLOCK_ENTITY_TYPES.register("gaspipefilter", () -> new BlockEntityType<>(TileGasPipeFilter::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_GASPIPEFILTER.get()), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileFluidPipeFilter>> TILE_FLUIDPIPEFILTER = BLOCK_ENTITY_TYPES.register("fluidpipefilter", () -> new BlockEntityType<>(TileFluidPipeFilter::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCK_FLUIDPIPEFILTER.get()), null));

	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileRelay>> TILE_RELAY = BLOCK_ENTITY_TYPES.register("relay", () -> new BlockEntityType<>(TileRelay::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.relay)), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TilePotentiometer>> TILE_POTENTIOMETER = BLOCK_ENTITY_TYPES.register("potentiometer", () -> new BlockEntityType<>(TilePotentiometer::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.potentiometer)), null));
	public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<TileCircuitMonitor>> TILE_CIRCUITMONITOR = BLOCK_ENTITY_TYPES.register("circuitmonitor", () -> new BlockEntityType<>(TileCircuitMonitor::new, Sets.newHashSet(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.circuitmonitor)), null));
