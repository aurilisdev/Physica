...
public class ElectrodynamicsFluids {
	...
	public static final DeferredHolder<Fluid, FluidNonPlaceable> FLUID_NITRICACID = FLUIDS.register("fluidnitricacid", () -> new FluidNonPlaceable(ElectrodynamicsItems.ITEM_CANISTERREINFORCED, new SimpleWaterBasedFluidType(References.ID, "fluidnitricacid", "nitricacid")));
